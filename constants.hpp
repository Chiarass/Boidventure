...
namespace constants{
    inline constexpr double delta_t{0.5};  //0.05 time increment. higher number, lower speeds.
    ...
    inline constexpr int swarm_number{800};
    inline constexpr double boid_size{10};  // the size of the sfml object representing the boid
